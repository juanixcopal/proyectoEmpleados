...
public class Empleado_Recibo extends Empleado{
    ...
    public Empleado_Recibo( String nombre, String apellido, String dni, String direccion, int edad, String formacionAcademica, int anosExperiencia, int horas_trabajadas, int pago_horas,
            String strRuc) {
        super(nombre, apellido, dni, direccion, edad, formacionAcademica, anosExperiencia, horas_trabajadas, pago_horas);
        this.strRuc = strRuc;
    ...
    public String imprimirBoletaPago() {
               return      "INFORME DEL TRABAJADOR" + "\n" +
                           ...
                           "Años de experiencia: " + super.getAnosExperiencia()+ "\n" +
                           "                        " + "\n" +
                           "Resumen de Pago" + "\n" +
