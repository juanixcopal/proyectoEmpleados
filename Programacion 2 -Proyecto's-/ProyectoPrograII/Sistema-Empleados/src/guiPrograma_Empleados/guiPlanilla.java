...
public class guiPlanilla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcMousePanel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondoplanilla.png"))); // NOI18N
        ...
        labelMetric11.setText("No° de Hijos:");
        ...
        labelCustom1.setText("HORA ESPAÑA");
    ...
    private void btnVolverMenu1ActionPerformed(java.awt.event.ActionEvent evt) {
    	// agregar el código de manejo aquí:
    ...
    /**
     * argumenta los argumentos de la línea de comando
     */
